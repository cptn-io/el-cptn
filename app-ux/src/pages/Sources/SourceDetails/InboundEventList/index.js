...
import { IconCircleCheckFilled, IconCircleDashed, IconCircleXFilled, IconClockPause, IconFileDescription, IconListDetails, IconRefresh, IconSend, IconSquarePlus } from "@tabler/icons-react";
            ...
            <table className="table data-table table-zebra w-full">
                ...
                <tbody style={{ maxHeight: '600px' }}>
                    {data.map(event => <tr key={event.id}>
                        <td className="whitespace-pre-wrap break-words"><a href="#" onClick={() => showDetails(event)}>{event.id}</a></td>
